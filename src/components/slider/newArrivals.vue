...
<div class="bg-white border border-gray-200">
  <div class="w-44 bg-green-340  p-3 flex items-center relative">
      <span class="uppercase font-semibold  text-xs text-white title"> featured product </span>
      <div class="w-10 h-10 bg-white rounded-full absolute top-0 -right-5"></div>
    </div>
  <carousel :paginationEnabled="false" :perPage="5" class="w-full">
    
    <slide
      v-for="arrival in arrivals"
      :key="arrival.imgSrc"
      class="px-2 py-3 scrollbar flex  justify-center
       hover:shadow-lg border border-transparent hover:border-gray-100 my-3 relative card"
    >
      <div
          class="uppercase shadow-2xl absolute top-3 right-2 w-10 h-5 text-xs text-white
           bg-red-600 font-semibold flex items-center justify-center rounded-lg"
          v-if="arrival.offre === true"
        >
          20%
        </div>
      <div class="text-center">
        <img class=" h-48 w-48 mx-auto" :src="arrival.imgSrc" alt="" />
        <span class="text-sm text-gray-700 font-semibold hover:text-green-340">
          {{ arrival.name }}
        </span>
        <div class="flex items-center justify-center mt-1">
          <span class="text-green-340 font-semibold mr-3">
            ${{ arrival.price }}
          </span>
          <span
            v-if="arrival.offre === true"
            class="font-semibold text-gray-400 line-through mt-2 text-sm"
          >
            ${{ arrival.newPrice }}
          </span>
        </div>
        <div
            class="items-center justify-center mt-3 mx-2 flex-btns absolute hidden top-20 right-10"
          >
            <button
          ...
          <div class="absolute top-44 counter hidden" style="right:78px">
            <div
  ...
  data() {
    return {
      ...
      arrivals: [
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o11-600x600.jpg",
          name: "Abricots",
          price: "9,00",
        },
        {
          imgSrc:
            "https://dnrsausagesupplies.ca/images/products/Lacto_Binder_Gluten_Free_1_kg_336.jpg",
          name: "soset",
          price: "6.5",
          newPrice: "4.5",
          offre: true,
        ...
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o6-600x600.jpg",
          name: "Cerises",
          price: "4.5",
        },
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o19-600x600.jpg",
          name: "Kiwis",
          price: "7.5",
          newPrice: "6.5",
          offre: true,
        ...
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o12-600x600.jpg",
          name: "Abricots",
          price: "9,00",
        },
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o4-600x600.jpg",
          name: "Banan",
          price: "6.5",
          newPrice: "4.5",
          offre: true,
        ...
        {
          imgSrc:
            "https://st2.depositphotos.com/1796303/5674/i/950/depositphotos_56745257-stock-photo-fresh-raw-beef-meat-isolatet.jpg",
          name: "Cerises",
          price: "4.5",
        },
        {
          imgSrc:
            "https://demo.wpthemego.com/themes/sw_revo/wp-content/uploads/2017/03/o7-300x400.jpg",
          name: "Kiwis",
          price: "7.5",
          newPrice: "6.5",
          offre: true,
